...
// [SecureKey] ENABLED: NimBLE backend. Bluedroid's ~60KB DRAM footprint was
// crashing both USB+BLE HID once a host connected. NimBLE ~halves the RAM and
// coexists with native USB on the ESP32-S3. Needs NimBLE-Arduino 1.4.3.
#define USE_NIMBLE

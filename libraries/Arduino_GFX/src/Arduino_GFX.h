...
// NOTE: The large CJK/unifont u8g2 fonts that normally ship here were removed
// from this vendored copy (SecureKey renders ASCII only — they added ~17 MB).
// If you actually need them, grab the full Makerfabs Arduino_GFX fork.
#endif
